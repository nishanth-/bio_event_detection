...
#        classifierParameters["examples"] = Parameters.cat("c=1000,4500,5000,7500,10000,20000,25000,27500,28000,29000,30000,35000,40000,50000,60000,65000", classifierParameters["examples"], "Classifier parameters for edges")
    if detector == "Detectors.EventDetector":
        classifierParameters["unmerging"] = Parameters.cat("c=500,1000,1500,2500", classifierParameters["unmerging"], "Classifier parameters for unmerging")        
        classifierParameters["modifiers"] = Parameters.cat("c=10000,20000,50000", classifierParameters["modifiers"], "Classifier parameters for modifiers")
        classifierParameters["edge"] = Parameters.cat("c=5000,7500,10000,20000,25000", classifierParameters["examples"], "Classifier parameters for edges")
        classifierParameters["trigger"] = Parameters.cat("c=5000,10000,20000,50000", classifierParameters["examples"], "Classifier parameters for triggers")
        classifierParameters["recall"] = Parameters.cat("0.65,0.7,0.85,1.0", classifierParameters["examples"], "Recall adjustment parameters")
    elif detector == "Detectors.EntityDetector":
        classifierParameters["examples"] = Parameters.cat("c=10000,20000,50000,80000", classifierParameters["examples"], "Classifier parameters for entities")
    elif detector == "Detectors.EdgeDetector":
        classifierParameters["examples"] = Parameters.cat("c=5000,7500,10000,20000,25000", classifierParameters["examples"], "Classifier parameters for edges")
